...
singleend1_test.sam   ----        contains entry of 
...
9. strand+ that has no potential duplicates AND out of possible sliding window
		strand+, ATCCATGG, chrom=3, POS=9999, 60M 10D 10M
		[good strand+ read with no potential duplicates]
		
10. strand+, UMI matches with #5, chrom doesnt match with #5
		forward, CTGTTCAC, chrom=2 [e.g. POS=50, 50M 40S]
...
14. strand-, UMI matches with 11, chrom matches with 11, same POS as #11, cigarstr
		...
		[contains S1, M, N, D and I]  adjPOS=100
